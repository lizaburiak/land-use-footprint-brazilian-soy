...
# Provides: dt_rename, dt_replace, dt_filter (column ops); area_fix, area_kick,
# area_merge, replace_RoW (region-code harmonisation); tcf_apply, fill_tcf,
# split_tcf (technical-conversion-factor handling); flow_pref, na_sum, vsub.
# (Adapted from the fineprint-global/fabio helper library.)
# ============================================================================
