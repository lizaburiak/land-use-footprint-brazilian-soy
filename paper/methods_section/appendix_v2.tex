...
\usepackage{tabularx}%
\usepackage{geometry}%
\usepackage{xr}% cross-references into the main methods document
\externaldocument{methods_v2}%
...
\title[Brazil's shifting soy land footprint: appendices]{Brazil's soy
land footprint is shifting toward China and toward the agricultural
frontier: appendices}
...
\abstract{TODO: Appendices to the Data and Methods working document.
...
\subsection{Agreement by importer}\label{subsubsec:byimporter}
