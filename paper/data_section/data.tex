...
%%
%% Sources verified against code/download_data.py, code/pipeline/,
%% code/prep/ and the data/*/README.md files (July 2026). All access
%% links live in the annex (annex_links.tex); the prose is kept
%% link-free for readability.
%%
