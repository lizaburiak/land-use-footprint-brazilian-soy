...
> See [`RUNBOOK.md`](RUNBOOK.md) for setup, data prerequisites, per-year caveats, and the
> optional Python multimode transport path; see [`WHAT_IS_MISSING.md`](WHAT_IS_MISSING.md)
> for known data gaps.
