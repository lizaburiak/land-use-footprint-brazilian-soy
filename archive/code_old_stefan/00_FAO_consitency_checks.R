...
CBS_SOY <- openxlsx::read.xlsx("data/old/CBS_SOY_2013_FAO.xlsx")
...
# write data
if (write == TRUE) {
  saveRDS(CBS_SOY, file = "results/intermediate/CBS_SOY.rds")
  saveRDS(consistency, file = "results/intermediate/FAO_consistency.rds")
}
