...
mr_sup_m <- readRDS("results/intermediate/FABIO/mr_sup_mass.rds")
mr_sup_v <- readRDS("results/intermediate/FABIO/mr_sup_value.rds")
mr_use <- readRDS("results/intermediate/FABIO/mr_use.rds")
...
nrcom <- nrow(items)
Y <- readRDS("results/intermediate/FABIO/mr_use_fd.rds")
Y_orig <- readRDS("results/intermediate/FABIO/mr_use_fd.rds")
...
if (write){
  saveRDS(Z_m, "results/intermediate/FABIO/Z_mass.rds")
  saveRDS(Z_v, "results/intermediate/FABIO/Z_value.rds")
  saveRDS(Y, "results/intermediate/FABIO/Y.rds")
  saveRDS(X, "results/intermediate/FABIO/X.rds")
}
