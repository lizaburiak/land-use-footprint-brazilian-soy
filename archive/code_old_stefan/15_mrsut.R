...
sup <- readRDS("results/intermediate/FABIO/sup_final.rds")
cbs <- readRDS("results/intermediate/FABIO/cbs_final.rds")
btd <- readRDS("results/intermediate/FABIO/btd_final.rds")

use <- readRDS("results/intermediate/FABIO/use_final.rds")
use_fd <- readRDS("results/intermediate/FABIO/use_fd_final.rds")
...
if (write){
  saveRDS(mr_sup_mass, "results/intermediate/FABIO/mr_sup_mass.rds")
  saveRDS(mr_sup_value, "results/intermediate/FABIO/mr_sup_value.rds")
}
...
rm(btd, template )
if (write) saveRDS(btd_cast, "results/intermediate/FABIO/btd_cast.rds")
...
if (write) saveRDS(supply_shares, "results/intermediate/FABIO/supply_shares.rds")
rm(agg)
gc()
...
if (write) {
  saveRDS(mr_use, "results/intermediate/FABIO/mr_use.rds")
  saveRDS(mr_use_fd, "results/intermediate/FABIO/mr_use_fd.rds")
}
