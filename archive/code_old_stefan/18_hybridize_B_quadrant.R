...
#Matrices necessary
sup <- read.csv("data/old/FABIO/FABIO_hybrid/fabio-exio_sup.csv") 
use <- read.csv("data/old/FABIO/FABIO_hybrid/fabio-exio_use.csv")
conc <- read.csv("data/old/FABIO/FABIO_hybrid/fabio-exio_conc.csv")
...
Y_all <- readRDS("results/intermediate/FABIO/Y.rds")
...
if (write) {
  saveRDS(B,"results/intermediate/FABIO/B.rds")
  saveRDS(Y_hybrid,"results/intermediate/FABIO/Y_hybrid.rds")
}
